...
void Print_Testing_3_Menu() {
    ...
    if (Robot_Type == 2) {
        Test4_btn.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, MAGENTA, BLACK, WHITE, "Drill Lift", 2);
        Test4_btn.drawButton(false);
        }
